...
class Registration:
    ...
    def __save_data(self):
        ...
        ##fieldnames = ['First name', 'Last name', 'User', 'Password', 'NewsAPI_Key', 'GenaiAPI_Key']
        fieldnames = ['User', 'Password', 'NewsAPI_Key', 'GenaiAPI_Key']
        data = {}
        ##data['First name'] = self.firstname.get()
        ##data['Last name'] = self.lastname.get()
        data['User'] = self.email.get()
        data['Password'] = self.pwd.get()
        data['NewsAPI_Key'] = '27b11c408f6e41cdb927b1b3e4943949'
        data['GenaiAPI_Key'] = 'AIzaSyD47p6F1bcdi15rhQXyJ1ounjBET4aDmEE'
